...
MOBILE_ITEMS = [
    ...
    ("videos.html", "VIDEOS"), ("case-studies/", "CASE STUDIES &amp; RESEARCH"),
  ...
  <section class="section">
    <div class="container grid grid-2" style="align-items:center">
      ...
      <div class="reveal">
        ...
        <div class="map-card-body"><strong>Shri JP Tower, New Railway Road</strong><span class="map-card-sub">Opp. Fire Station, Sector 6, Gurugram (Haryana)</span><p>A modern, technology-enabled laboratory with a roadmap toward digital pathology and advanced molecular testing.</p></div></div>
      </div>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container grid grid-2" style="align-items:stretch;gap:2.5rem">
      <div class="reveal" id="enquiry">
        ...
        <form id="enquiry-form" class="form-card form-grid" style="margin-top:1.2rem" novalidate>
...
PAGES.append(dict(filename="partner.html", title="Partner With Us", active="partner",
  ...
  <section class="section section--soft">
    <div class="container" style="max-width:820px">
      ...
      <form id="enquiry-form" class="form-card form-grid form-grid--2col reveal" novalidate>
        <div class="form-head">
